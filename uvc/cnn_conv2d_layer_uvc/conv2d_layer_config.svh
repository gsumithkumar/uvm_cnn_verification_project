...
//
//-------------------------------------------------------------------------------------------------------------
class conv2d_layer_config extends uvm_object;
    ...
    virtual conv2d_layer_if m_vif;

    `uvm_object_utils_begin(conv2d_layer_config)
    ...
    //------------------------------------------------------------------------------
    function new (string name = "conv2d_layer_config");
        super.new(name);
    endfunction : new

endclass : conv2d_layer_config
