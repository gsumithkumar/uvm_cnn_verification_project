//-------------------------------------------------------------------------------------------------------------
// File Description : 
// This class is a UVM configuration object used to control how the CNN Convolution Layer Agent for Input is built and
...
//  is_active   - Indicates whether the driver and sequencer are created and allowed to drive the DUT.
...
//
//-------------------------------------------------------------------------------------------------------------
class cnn_conv_input_config extends uvm_object;
    ...
    `uvm_object_utils_begin(cnn_conv_input_config)
    ...
    //------------------------------------------------------------------------------
    function new (string name = "cnn_conv_input_config");
        super.new(name);
    endfunction : new

endclass : cnn_conv_input_config
